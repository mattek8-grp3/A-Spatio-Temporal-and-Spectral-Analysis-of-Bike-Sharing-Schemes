...
class Data:
    ...
    def __init__(self, city, year, month, blacklist = None):
        """
        Parameters
        ----------
        city : str
        ...
        self.df, self.d_index = get_data(city, year, month, blacklist)
    ...
    def get_busy_stations(self, days, normalise=True):
        """
        Finds the corresponding degree to each docking station and returns a
        sorted list of the docking stations and their degree.
